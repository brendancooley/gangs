...
# build plots after data as been loaded
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.cap = paste0("Estimated territorial partition of Chicago, ", minY, "-", maxY, ". Light gray tracts are estimated to have no gang activity. \\label{fig:map}"), fig.height=9, dpi=300, fig.pos="t"}
