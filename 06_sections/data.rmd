...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.cap = paste0("Homicides and non-fatal shootings per capita ", bruhn_sy, "-", bruhn_ey, ". \\label{fig:hnfs}"), fig.height=6, dpi=300, fig.pos="t"}
