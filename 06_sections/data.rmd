...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.cap = "Average CPD-reported gang turf and black and latino population shares. Source: @Bruhn2019 and American Community Survey. \\label{fig:cpd_ethnic}", fig.height=9, dpi=300, fig.pos="t"}
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.cap = paste0("Changes in CPD-reported gang turf, ", bruhn_sy, "-", bruhn_ey, ". Source: @Bruhn2019. \\label{fig:turf_evolution}"), fig.height=9, dpi=300, fig.pos="t"}
