In this section we derive our estimand from a model of the data generating process for violence. We do so by distinguishing between different types of violence and generating a covariance structure between them. We impose the minimal set of assumptions required for identification of the estimand from our data.
