...
- `r cpd_gangs_N` gangs own at least one tract according to CPD, but three largest gangs we detect occupy `r round(gd_vl_bps_area / all_area*100, 0)` percent of all gang turf
