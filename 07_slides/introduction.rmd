...
map_margins <- c(.1, .1, .1, .1)

```

# Gunshots and Turf Wars {id="introduction"}
...
- Territorial conflict between rival gangs is responsible for much of the violence in American cities 
...
tmap_arrange(chi_turf_binary_map, cluster_binary_map)
