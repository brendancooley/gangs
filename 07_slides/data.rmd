...
- Report number of gangs and territorial partition
- Collapse panel
...
- Assign a tract to a gang if 1) it owns plurality of tract area and 2) it owns at least 10 percent of tract
	+ `r cpd_gangs_N` satisfy criteria for inclusion
...
<center>
*Treat territorial partition as static over time*
</center>

## Turf, Change over Time {id="turf_evolution"}
...
<a href="#/turf_distribution">Territorial Distribution</a> &nbsp <a href="#/ethnicity">Ethnicity</a>
