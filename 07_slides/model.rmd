...
- Probability a member of gang $\pi(i)$ is operating on territory $i$
$$
\frac{1}{n_{\pi(i)}}
$$
...
\left( \frac{m_{\pi(i)}}{n_{\pi(i)}} \right)^2 \text{Var} [  \epsilon_{k, \pi(i)}^t ] \right) +  \left( \frac{m_{\pi(i)}}{n_{\pi(i)}} \right)^2 \text{Var}[ \xi_{\pi(i)}^t ] + \psi_i & \text{if } i = j \\
\color{bcOrange} \sum_{k \neq \pi(i)} \left( 
\left( \frac{m_{\pi(i)}}{n_{\pi(i)}} \right)^2 \text{Var} [ \epsilon_{k, \pi(i)}^t ] \right) +  \left( \frac{m_{\pi(i)}}{n_{\pi(i)}} \right)^2 \text{Var} [ \xi_{\pi(i)}^t ] & \text{if } \pi(i) = \pi(j) \\
